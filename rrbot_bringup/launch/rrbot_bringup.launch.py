...
def generate_launch_description():
    ...
    base_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
                PathJoinSubstitution([
                    FindPackageShare('rrbot_control'),
                    'launch',
                    'rrbot_base.launch.py'
                ])
            ]),
        launch_arguments={
            "controllers_file": "rrbot_controller.yaml",
            "description_file": "rrbot.xacro",
            "prefix": prefix,
    ...
    return LaunchDescription(declared_arguments + [base_launch] + [position_publisher])