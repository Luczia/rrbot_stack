...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "controllers_file",
            default_value="rrbot_controller.yaml",
    ...
    return LaunchDescription(declared_arguments + nodes + [gz_launch])
